...
This example demonstrates the explicitly selected legacy v1 small layout. Existing v1 projects remain supported and are not migrated implicitly.
...
Use this table only after `noc work --json` reports a v1 feature project.
