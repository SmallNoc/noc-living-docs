...
4. Read only the affected docs listed in the work plan, especially `agent-guide.md` and `guardrails.md`.
5. Read `requirements.md`, `status.md`, and `test-record.md` only when the change affects intent, behavior, or verification.
...
6. Do not churn docs that did not materially change.
7. Report which NOC docs were checked or updated.
